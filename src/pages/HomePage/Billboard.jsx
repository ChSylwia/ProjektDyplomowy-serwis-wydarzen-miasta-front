...
const Billboard = () => {
  ...
  const slides = [
    {
      id: 1,
      src: 'https://chwile-plocka.s3.eu-north-1.amazonaws.com/Most-Plock.webp',
      alt: 'Most w Płocku'
    },
    {
      id: 2,
      src: 'https://chwile-plocka.s3.eu-north-1.amazonaws.com/Teatr_w_Plocku.webp',
      alt: 'Teatr w Płocku'
    },
    {
      id: 3,
      src: 'https://chwile-plocka.s3.eu-north-1.amazonaws.com/Ratusz-Plock.webp',
      alt: 'Ratusz w Płocku'
    }
  ]
